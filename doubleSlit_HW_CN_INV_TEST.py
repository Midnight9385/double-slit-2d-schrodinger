...
"""
This is wayyyy slower than the other way but neat that it works the same and has a consistent timing whereas
the solver has often faster times but occasionally has times that are like triple this method

another downside...as L increases it takes wayyyy longer to calculate the inverse of A go figure
"""
...
for i in tqdm(range(1,Nt)):
    ...
    psi_vect = csc_matrix._matmul_sparse(csc_matrix(b), Ainv).asformat("array") # Resolvemos el sistema para este paso temporal.
    # print(psi_vect)
